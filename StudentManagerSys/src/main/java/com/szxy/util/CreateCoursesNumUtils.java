...
public class CreateCoursesNumUtils {
	
	public static final String PATH = "src/main/resources/CoursesNum.dat";
	//测试生成课程编号工具
	public static void main(String[] args) {
		String id = CreateCoursesNumUtils.printId();
